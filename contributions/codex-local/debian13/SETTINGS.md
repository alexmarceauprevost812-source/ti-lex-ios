...
Le centre de contrôle TI-LEX regroupe les panneaux XFCE et GNOME disponibles dans Debian : comptes utilisateurs, date/heure, accessibilité, confidentialité, applications par défaut, logiciels, réseau, écrans, son et énergie.
